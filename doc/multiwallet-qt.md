...
In order to support loading of multiple wallets in bitcommerce-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is bitcommerce.cpp.
...
Changes to bitcommerce.cpp
----------------------
bitcommerce.cpp is the entry point into bitcommerce-qt, and as such, will require some minor modifications to provide hooks for
