...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("BitCommerce Core bitcommerce-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  bitcommerce-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded bitcommerce transaction") + "\n" +
                               "  bitcommerce-tx [options] -create [commands]   " + _("Create hex-encoded bitcommerce transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded bitcommerce transaction
