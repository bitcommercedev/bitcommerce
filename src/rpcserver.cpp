...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* BitCommerce features */
        {"bitcommerce", "masternode", &masternode, true, true, false},
        {"bitcommerce", "listmasternodes", &listmasternodes, true, true, false},
        {"bitcommerce", "getmasternodecount", &getmasternodecount, true, true, false},
        {"bitcommerce", "masternodeconnect", &masternodeconnect, true, true, false},
        {"bitcommerce", "masternodecurrent", &masternodecurrent, true, true, false},
        {"bitcommerce", "masternodedebug", &masternodedebug, true, true, false},
        {"bitcommerce", "startmasternode", &startmasternode, true, true, false},
        {"bitcommerce", "createmasternodekey", &createmasternodekey, true, true, false},
        {"bitcommerce", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"bitcommerce", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"bitcommerce", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"bitcommerce", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"bitcommerce", "getmasternodescores", &getmasternodescores, true, true, false},
        {"bitcommerce", "mnbudget", &mnbudget, true, true, false},
        {"bitcommerce", "preparebudget", &preparebudget, true, true, false},
        {"bitcommerce", "submitbudget", &submitbudget, true, true, false},
        {"bitcommerce", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"bitcommerce", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"bitcommerce", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"bitcommerce", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"bitcommerce", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"bitcommerce", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"bitcommerce", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"bitcommerce", "checkbudgets", &checkbudgets, true, true, false},
        {"bitcommerce", "mnsync", &mnsync, true, true, false},
        {"bitcommerce", "spork", &spork, true, true, false},
        {"bitcommerce", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"bitcommerce", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use bitcommerced, or the -server option to bitcommerce-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> bitcommerce-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:41143/\n";
}
