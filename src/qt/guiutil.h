...
/** Utility functions used by the BCOM Qt UI.
 */
namespace GUIUtil
{
...
// Render BCOM addresses in monospace font
...
// Parse "bitcommerce:" URI into recipient object, return true on successful parsing
