...
public:
    ...
    void setZBitCommerceControlLabels(int64_t nAmount, int nQuantity);
...
//    void coinControlClipboardChange();
    ...
    void on_pushButtonMintzBCOM_clicked();
    void on_pushButtonMintReset_clicked();
    void on_pushButtonSpentReset_clicked();
    void on_pushButtonSpendzBCOM_clicked();
    void on_pushButtonZBitCommerceControl_clicked();
