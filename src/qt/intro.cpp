...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("BCOM Core"),
     ...
     * override -datadir in the bitcommerce.conf file in the default data directory
     * (to be consistent with bitcommerced behavior)
     */
    if (dataDir != getDefaultDataDirectory())
