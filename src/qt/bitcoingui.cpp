                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("BCOM Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a BCOM address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and bitcommerce: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zBCOM"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About BCOM Core"), this);
    aboutAction->setStatusTip(tr("Show information about BCOM Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for BCOM"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your BCOM addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified BCOM addresses"));
    ...
    openAction->setStatusTip(tr("Open a BCOM: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the BCOM Core help message to get a list with possible BCOM command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("BCOM Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to BCOM network", "", count));
}
...
{
    QString strTitle = tr("BCOM Core"); // default title
