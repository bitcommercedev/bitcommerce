                                                    ...
                                                    transactionView(0)
{
    ...
    typeWidget->addItem(tr("Received BitCommerce from zBitCommerce"), TransactionFilterProxy::TYPE(TransactionRecord::RecvFromZerocoinSpend));
    ...
    typeWidget->addItem(tr("Zerocoin Spend, Change in zBitCommerce"), TransactionFilterProxy::TYPE(TransactionRecord::ZerocoinSpend_Change_zBitCommerce));
