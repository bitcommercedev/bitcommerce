Contributing to BCOM Core
============================

The BCOM Core project operates an open contributor model where anyone is
...
The following applies to code changes to the BCOM Core project, and is not to be
confused with overall BCOM Network Protocol consensus changes.

Whether a pull request is merged into BCOM Core rests with the project merge
...
Patches that change BCOM consensus rules are considerably more involved than
...
Where a patch set proposes to change the BCOM consensus, it must have been
...
The project leader is the release manager for each BCOM Core release.
