...
#   c) node1 mines 32 blocks, so now node 0 has 60001bitcommerce, node 1 has 4250bitcommerce, node2 has none.
#   d) node0 sends 601 bitcommerce to node2, in two transactions (301 bitcommerce, then 300 bitcommerce).
